 ...
 */
export declare class ConsoleLogger extends ContribLogger implements LoggerInterface {
 ...
 */
export declare class ConsoleMetrics extends ContribMetrics implements MetricsInterface {
