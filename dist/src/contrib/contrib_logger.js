...
var ContribLogger = /** @class */ (function (_super) {
     ...
     */
    ContribLogger.prototype.log = function (message, payload, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.call('log', message, payload, options)];
            });
        });
    };
    /**
     ...
     * @param options Optional call-specific options
     */
    ContribLogger.prototype.logError = function (message, payload, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.call('error', message, payload, options)];
            });
        });
    };
    /**
     ...
     * @param options Optional call-specific options
     */
    ContribLogger.prototype.logInfo = function (message, payload, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.call('info', message, payload, options)];
            });
        });
    };
    /**
     ...
     * @param options Optional call-specific options
     */
    ContribLogger.prototype.logWarn = function (message, payload) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.call('warn', message, payload)];
            });
        });
    };
