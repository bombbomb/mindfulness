...
var Mindfulness = /** @class */ (function () {
     ...
     */
    Mindfulness.prototype.before = function (details, options) {
                ...
                before = function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        return [2 /*return*/, (new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                                var callOptions, args, result;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            callOptions = this.getCallOptions(options);
                                            if (!callOptions.before) {
                                                return [2 /*return*/, resolve(__assign({}, details))];
                                            }
                                            args = [];
                                            switch (this.type) {
                                                // logger
    ...
    Mindfulness.prototype.debug = function () {
        var _a;
        var args = [];
     ...
     */
    Mindfulness.prototype.getCallOptions = function (options) {
